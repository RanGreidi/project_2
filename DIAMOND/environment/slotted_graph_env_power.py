...
class SlottedGraphEnvPower:
    ...
    def __init__(self,
        ...
        self.initial_num_of_flows = initial_num_of_flows
    ...
    def _transmit_singe_timestep(self, active_links , total_time_slots):
        ...
        packet_size = 1e1 #self.packet_size_for_delay_measurement
    ...
    def calc_reward(self, metadata, action):
        ...
        for i in range(len(curent_flow_path) - 1):
            ...
            if self.bandwidth_edge_list[link_idx] < minimum_BW_for_current_path: minimum_BW_for_current_path = self.bandwidth_edge_list[link_idx]
